...
const ActionDropdown = ({ onEdit, onRequestDelete }) => {
  ...
  const dropdownContent = (
    <div
      ref={dropdownRef}
      className="fixed z-50 w-40 mt-2 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-300 dark:border-gray-700/50"
