...
const ActionDropdown = ({ role, leadId, onEdit, onRequestDelete, onAddToCampaign }) => {
  ...
  const dropdownContent = (
    <div
      ref={dropdownRef}
      className="fixed z-50 w-48 mt-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700/50 rounded-md shadow-lg"
